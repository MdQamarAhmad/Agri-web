...
export default function Home() {
      ...
      <div className="container" >
        <nav>
          ...
          <ul>
            ...
            <li><Link className='li' style={{display:'flex'}} to="#">Dropdown<span style={{display:'flex',alignItems:'center',marginLeft:'2px',marginTop:'2px'}}><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-chevron-down" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708"/>
      ...
      <div className='container1' >
        <div className="part1" id='partImg'>
        </div>
        <div className="part2">
      ...
      <br /><br /><br /><br /><br /><br /><br />
       ...
       <div onClick={scrollTo} style={{width:'40px',height:'40px',backgroundColor:'#116530',display:'grid',placeItems:'center',position:"relative",left:'95.5%',top:'-20px',zIndex:'2',cursor:'pointer'}}><i className="fa-solid fa-arrow-up"></i></div>
       <Outlet/>
        </>
  )
}
